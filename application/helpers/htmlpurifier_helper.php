...
if (!function_exists('html_purify')) {
    function html_purify($dirty_html, $config = "comment")
    {
        ...
        if (is_array($dirty_html)) {
            ...
            switch ($config) {
                case 'comment':
                    ...
                    $config->set('HTML.Allowed', 'p,a[href|title],abbr[title],acronym[title],b,strong,blockquote[cite],code,em,i,span[style],br');
