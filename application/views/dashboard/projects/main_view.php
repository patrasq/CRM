        ...
        <tbody>
            ...
            if($all_projects) { 
                foreach($all_projects as $row) {
                    ...
                    $row["Deadline"],
                    "</td>" ,
                    "<td><a href='".get_profile($row['Supervizor'])."'>" ,
                    get_cached_info("FirstName", $this->config->config['tables']['employees'], "ID", $row['Supervizor']) , " " , get_cached_info("LastName", $this->config->config['tables']['employees'], "ID", $row['Supervizor']) . "</a>",
                    "</td>" ,
                    "<td>" ,
                    $row["Status"] ? "Completed" : "In progress",
                    "</td>" ,
